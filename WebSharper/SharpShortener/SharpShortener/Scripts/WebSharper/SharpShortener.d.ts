declare module SharpShortener {
    ...
    module FeedbackPagelet {
        ...
        var FeedbackFormlet : {
            (baseAdr: string): __ABBREV.__Data.Formlet<__ABBREV.__FeedbackPagelet.Ergebnis>;
        };
        var Main : {
            (baseAdr: string): __ABBREV.__Html.IPagelet;
        };
    }
...
declare module __ABBREV {
    ...
    export import __FeedbackPagelet = SharpShortener.FeedbackPagelet;
